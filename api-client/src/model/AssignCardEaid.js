...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MastercardEzaccessForIssuersApi.AssignCardEaid = factory(root.MastercardEzaccessForIssuersApi.ApiClient);
  }
  ...
  /**
   * The AssignCardEaid model module.
   * @module model/AssignCardEaid
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AssignCardEaid</code>.
   * @alias module:model/AssignCardEaid
   * @class
   */
  ...
  /**
   * Constructs a <code>AssignCardEaid</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AssignCardEaid} obj Optional instance to populate.
   * @return {module:model/AssignCardEaid} The populated <code>AssignCardEaid</code> instance.
   */
