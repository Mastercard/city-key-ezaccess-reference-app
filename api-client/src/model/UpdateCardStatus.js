...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MastercardEzaccessForIssuersApi.UpdateCardStatus = factory(root.MastercardEzaccessForIssuersApi.ApiClient);
  }
  ...
  /**
   * The UpdateCardStatus model module.
   * @module model/UpdateCardStatus
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UpdateCardStatus</code>.
   * @alias module:model/UpdateCardStatus
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateCardStatus</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateCardStatus} obj Optional instance to populate.
   * @return {module:model/UpdateCardStatus} The populated <code>UpdateCardStatus</code> instance.
   */
